...
QT_MOC_LITERAL(1, 14, 8), // "fileSent"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 8), // "fileName"
QT_MOC_LITERAL(4, 33, 12), // "fileReceived"
QT_MOC_LITERAL(5, 46, 7), // "content"
QT_MOC_LITERAL(6, 54, 13), // "errorOccurred"
QT_MOC_LITERAL(7, 68, 3), // "msg"
QT_MOC_LITERAL(8, 72, 21) // "activeEditorsReceived"

    },
    "NetworkWorker\0fileSent\0\0fileName\0"
    "fileReceived\0content\0errorOccurred\0"
    "msg\0activeEditorsReceived"
};
...
void NetworkWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->fileReceived((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        case 2: _t->errorOccurred((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 3: _t->activeEditorsReceived((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NetworkWorker::fileSent)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (NetworkWorker::*)(const QString & , const QString & );
        ...
        {
            using _t = void (NetworkWorker::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NetworkWorker::activeEditorsReceived)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 0
void NetworkWorker::fileSent(const QString & _t1)
{
...
// SIGNAL 1
void NetworkWorker::fileReceived(const QString & _t1, const QString & _t2)
{
...
// SIGNAL 3
void NetworkWorker::activeEditorsReceived(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
