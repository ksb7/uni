...
<div id="tabselect">
	<div id="form2">
	    <form action="PopEtnii.php" method="post" id="dorm1"> 
	        <input type="text" name="localitate" placeholder="Introdu Localitatea"/><br>
	        <input type="text" name="etnie" placeholder="Introdu Etnia"/><br>
	        <input type="text" name="mediu" placeholder="Introdu Mediul"/><br>
	...
	<div>
	  	<table class="center">
	        ...
	        <?php
	                include_once 'SelectPopEtnii.php';
	        ?>
	    </table>
	</div>
</div>
